...
function AlertDialogAction({
  ...
  size = 'default',
  ...props
}: VariantProps<typeof buttonVariants> & React.ComponentProps<typeof AlertDialogPrimitive.Action>) {
...
function AlertDialogCancel({
  ...
  size = 'default',
  ...props
}: VariantProps<typeof buttonVariants> & React.ComponentProps<typeof AlertDialogPrimitive.Cancel>) {
